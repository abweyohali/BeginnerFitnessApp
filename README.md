...
- Functional text-based menu in `Main.java`
- Basic progress tracking
- All classes compile and run
- Early version of the program structure is in place
...
## Files Included
- **Main.java** – user interaction and program menu  
- **User.java** – stores user information and progress  
- **Exercise.java** – creates exercise objects  
